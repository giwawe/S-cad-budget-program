...
def test_generate_quote_review_report_groups_review_rows(tmp_path: Path):
    ...
    assert "| 8 | 104 | 主材包 | 1 |  | 按模板生成 |  |" in report_text
...
def _write_quote_workbook(path: Path) -> None:
    ...
    rows = [
        ...
        [102, "砌240厚砖墙", "m2", 6, None, None, None, None, None, "自动汇总", "全屋", None, "新砌240mm砖墙面积汇总", "自动生成-默认推断", "墙体标识缺少高度"],
        [103, "外墙修补", "m2", 0, None, None, None, None, None, "自动汇总", "全屋", None, "外墙修补范围面积汇总", "自动生成-异常提示", "需要确认修补范围"],
        [104, "主材包", "项", 1, None, None, None, None, None, "模板默认", None, None, None, "按模板生成", None],
    ]
