...
- 可用 `cad-budget quote-report quote.xlsx --markdown-output quote-review.md` 从报价 Excel 的可见复核列生成 Markdown 复核报告，按 `自动生成-默认推断`、`自动生成-异常提示`、`按模板生成` 分组列出需要设计师/预算员复核的行，便于真实模板回归对比。
